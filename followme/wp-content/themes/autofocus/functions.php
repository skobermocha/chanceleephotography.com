...
function sandbox_globalnav() {
    echo	'<div id="menu">';
    echo	'<ul><li class="page_item"><a href="http://chanceleephotography.com" title="'. get_bloginfo('name') .'" rel="home">Home</a></li>';
    echo	'<li class="page_item"><a href="/followme/about/">About</a></li><li><a href="/followme/" alt="/followme/">Follow Me</a></li>';
    echo	'<li class="page_item"><a href="http://gallery.chanceleephotography.com" alt="http://gallery.chanceleephotography.com" target="_blank">Gallery</a></li>';
    echo	'<li class="page_item"><a href="/followme/contact/" alt="/followme/contact/">Contact</a></li></ul>';
    echo	'</div>';
}
...
function custom_comments($comment, $args, $depth) {
  ...
  ?>
  	<li id="comment-<?php comment_ID() ?>" <?php comment_class() ?>>
  		...
  		<div class="comment-meta"><?php printf(__('Posted %1$s at %2$s <span class="meta-sep"></span>', 'your-theme'),
  					get_comment_date(),
  					get_comment_time(),
